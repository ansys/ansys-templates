    ...
    if args.local_wheels:
        ...
        if sys.platform == "win32":
            ...
            if path_too_long and not is_long_paths_enabled():
                raise Exception(
                    f"Path length to file(s) in '{args.local_wheels}' exceeds the maximum limit in Windows. Please enable Windows Long Path support or use a shorter path. You can find information on how to enable this at https://pip.pypa.io/warnings/enable-long-paths"
                )
