...
DESIRED_STRUCTURE = [
    ...
    f"src/ansys/solutions/{{ cookiecutter.__solution_name_slug }}/ui/components/auto_update_switch.py",
    ...
    f"src/ansys/solutions/{{ cookiecutter.__solution_name_slug }}/ui/views/result_files_view.py",
