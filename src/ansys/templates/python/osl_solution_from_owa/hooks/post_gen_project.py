...
def main():
    ...
    if len("{{ cookiecutter.__optiSLang_app_file }}".replace(" ", "")):
        copy_file_to_assets_folder("{{ cookiecutter.__optiSLang_app_file }}",  str(ASSETS_DIRCTORY / "{{ cookiecutter.__optiSLang_app_file_name }}"))
