...
from ansys.solutions.solution.solution.definition import SolutionSolution
from ansys.solutions.solution.ui.pages import about_page, first_page, second_page
