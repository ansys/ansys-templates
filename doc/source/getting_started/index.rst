...
For users
^^^^^^^^^
In order to install my_solution, make sure you
...
.. code:: bash
    ...
    poetry run python -m pip install ansys-solutions-my-solution

For developers
^^^^^^^^^^^^^^
Installing Pymy_solution in developer mode allows
