...
from ansys.solutions.my_osl_solution.solution.definition import My_Osl_SolutionSolution
...
from ansys.solutions.my_osl_solution.ui.components.logs_table import LogsTable
from ansys.solutions.my_osl_solution.ui.utils.common_functions import update_list_of_tabs
from ansys.solutions.my_osl_solution.ui.views import (
    design_table_page,
...
from ansys.solutions.my_osl_solution.ui.utils.common_functions import extract_dict_by_key
...
def update_page_content(active_tab, pathname):
    ...
    project = DashClient[My_Osl_SolutionSolution].get_project(pathname)
