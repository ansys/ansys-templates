...
from ansys.solutions.opf_soln.model.utils import check_if_file_is_empty
...
class ProblemSetupStep(StepModel):
    ...
    # File storage
    project_file: FileReference = FileReference("Problem_Setup/opf_soln ")
    properties_file: FileReference = FileReference("Problem_Setup/ ")
    ...
    def upload_project_file_to_project_directory(self) -> None:
        ...
        original_project_file = (
            Path(__file__).parent.absolute().parent / "model" / "assets" / "opf_soln "
        )
    ...
    def upload_properties_file_to_project_directory(self) -> None:
        ...
        original_properties_file = (
            Path(__file__).parent.absolute().parent / "model" / "assets" / " "
        )
