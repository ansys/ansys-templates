...
from ansys.solutions.opf_soln.solution.definition import Opf_SolnSolution
from ansys.solutions.opf_soln.solution.monitoring_step import MonitoringStep
from ansys.solutions.opf_soln.ui.colorscale import ANSYS_COLORSCALE
from ansys.solutions.opf_soln.ui.monitoring_tabs.design_table_page import DesignTable
...
def update_graphs(selected_axis_1, selected_axis_2, selected_axis_3, selected_design_id, pathname):
    ...
    project = DashClient[Opf_SolnSolution].get_project(pathname)
